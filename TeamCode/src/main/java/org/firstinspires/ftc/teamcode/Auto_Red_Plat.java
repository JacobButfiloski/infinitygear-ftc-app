...
@Autonomous(name = "Red Plat", group="Iterative Opmode")
public class Auto_Red_Plat extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                Reset();
                while (!(leftMotorBack.getCurrentPosition() >= 1.55 * 1120 || isStopRequested())) {
                    Right_Strafe();
                    Half_Power();
                }
                Reset();
                ...
                Zero_Power();
                sleep(2500);
                while (!(leftMotorBack.getCurrentPosition() >= 1.75 * 1120 || isStopRequested())) {
                    Half_Power();
                    Forward();
                }
                Reset();
                ...
                Reset();
                while (!(leftMotorBack.getCurrentPosition() >= 3.55 * 1120 || isStopRequested())) {
                    Half_Power();
                    Backwards();
                }
                Reset();
